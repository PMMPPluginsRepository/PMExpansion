...
class CaveVinesBodyWithBerries extends BaseCaveVines{
	...
	public function getStateSerialize() : ?Closure{
		return static fn(CaveVinesBodyWithBerries $block) : BlockStateWriter => BlockStateWriter::create(BlockTypeNames::CAVE_VINES_BODY_WITH_BERRIES)
			->writeInt(BlockStateNames::GROWING_PLANT_AGE, $block->getAge());
	}

	public function getStateDeserialize() : ?Closure{
		return fn(BlockStateReader $in) : CaveVinesBodyWithBerries => ExtraVanillaBlocks::CAVE_VINES_BODY_WITH_BERRIES()
